...
const MagicButton = ({
  ...
  return (
    ...
    >
      <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#4BC9C0_0%,#393BB2_50%,#4973ff_100%)]" />
      <span
      ...
      >
        ...
        {disabled ? (
          <Image
            ...
            height={50}
            src="/loading.png"
            className="pin  mx-auto text-center w-5 h-5"
          />
        ) : (
          text
        )}
