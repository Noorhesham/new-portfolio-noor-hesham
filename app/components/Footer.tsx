    ...
    <footer className="bg-slate-900 uppercase">
      ...
      <MaxWidthWrapper className="w-full  text-white mb-[100px]  md:mb-5 pb-10" id="contact">
        ...
        <div className="flex flex-col items-center">
          ...
          <a href="mailto:noordragon2004@gmail.com">
            <MagicButton text="Let's get in touch" icon={<FaLocationArrow />} position="right" />
          </a>
        </div>
        <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
          <p className="md:text-base text-sm md:font-normal font-light">Copyright © 2024 Noor Hesham</p>
